...
export const HERO_CONTENT = {
  ...
  description:
    "Now engineering IIoT pipelines and dynamic Value Stream Maps at Insituform, data-engineering raw production telemetry into faster lead times and smarter decisions.",
